...
o Процесът е програма по време на нейното изпълнение – да хване инструкциите на дадена програма отгоре надолу и след като свърши – процесът се терминира. От една програма може да има множество процеси – едновременно или един след друг. Във всеки един момент всеки един процес изпълнява точно една програма. Абстракция на ОС, всеки процес се асоциира с една програма.
o ОС може да прави няколко неща с процеси – да създава или да унищожава (спешно да го убие, терминира), може да спира – да приоритизира– да го вкара в затвора и да не ползва ресурси. Също може и да ги стартира наново – след като ги е спряла.
o ОС предоставя механизми за синхронизация и комуникация между процесите. Комуникация – да се прехвърлят данни между процесите.
o Синхронизация между процесите (при 1 ядро) – многонишково изпълнение.
o Имаме абстракцията, че процесът има нишка, е на нишка, тази абстракция не е хардуерно лимитирана и ОС създава илюзията – т.е. дори и да е последователно – пак са нишки.
o Когато са на хардуерно ниво – се извършват паралелно и се спестява пъти време. Ние, кодърите, избираме с колко нишки да изпълняваме кода – т.е. коя нишка за какво да се използва.
o Може да имаме работа с динамични нишки – част от кода само на една нишка, друга на 5, друга на 6 и т.н.
o Всяка нища се свързва с отделен PC (Programming Counter), за да помни до къде е стигнала.
o Нишка - единица за изпълнение на процес
