...
Операционната система предоставя механизми за синхронизиране и обменяне на данни между отделните процеси. Тя може да извършва 4 операции с процеси:
...
Когато работим с голямо количество код. Този код се структурира по някъде начин. Този начин се нарича архитектура. Примерно се разделя на логически елементи.
